...
var e = {
    ...
    stickyPost: function () {
        var scrollpos = window.scrollY;
        var spLeft = e.select('.sticky-post');
        var spRight = e.select('.sticky-post-right');

        if (e.isVariableDefined(spLeft) && e.isVariableDefined(spRight)) {
            var add_class_on_scroll = () => {
                spLeft.addClass("sticky-post-sticked");
                spRight.addClass("sticky-post-sticked");
            };
            var remove_class_on_scroll = () => {
                spLeft.removeClass("sticky-post-sticked");
                spRight.removeClass("sticky-post-sticked");
            };
